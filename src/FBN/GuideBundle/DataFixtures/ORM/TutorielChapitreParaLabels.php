<?php
// src/FBN/GuideBundle/DataFixtures/ORM/TutorielChapitreParaLabels.php
...
class TutorielChapitreParaLabels extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        foreach($rangs as $i => $rang)
        {
            ...
            $tutorielchapitrepara[$i]->setTutorielChapitre($this->getReference('tutorielchapitrelabels-' . ($tutorielchapitre_ids[$i]-1))); 

            $this->addReference('tutorielchapitreparalabels-' . $i, $tutorielchapitrepara[$i]); 

            $tutorielchapitrepara[$i]->setImage($this->getReference('imagetutorielchapitreparalabels-' . $i));                                          
        }              
