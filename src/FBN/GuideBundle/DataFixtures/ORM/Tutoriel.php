<?php
// src/FBN/GuideBundle/DataFixtures/ORM/Tutoriel.php
...
use FBN\GuideBundle\Entity\Tutoriel as Tuto;

class Tutoriel extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        {
            $tutoriel[$i]->setDescription($description);
