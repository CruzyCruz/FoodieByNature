<?php
// src/FBN/GuideBundle/DataFixtures/ORM/TutorielChapitreParaBiodynamie.php
...
class TutorielChapitreParaBiodynamie extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        foreach($ranks as $i => $rank)
        {
            ...
            $tutorielchapitrepara[$i]->setTutorielChapitre($this->getReference('tutorielchapitrebiodynamie-' . ($tutorielchapitre_ids[$i]-1))); 

            $this->addReference('tutorielchapitreparabiodynamie-' . $i, $tutorielchapitrepara[$i]); 

            $tutorielchapitrepara[$i]->setImage($this->getReference('imagetutorielchapitreparabiodynamie-' . $i));                                          
        }              
