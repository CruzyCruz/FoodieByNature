...
class Map
{
	...
	public function hydrate(array $latlngs, $rubrique)
	{
	...
	public function getMap(array $latlngs, $rubrique)
	{
		$this->hydrate($latlngs, $rubrique);		
	...
	protected function setRubrique($rubrique)
	{
    ...
    {    	
    	...
    	if ($this->rubrique == 'restaurant' || $this->rubrique == 'evenement' || $this->rubrique == 'caviste')
    	{
